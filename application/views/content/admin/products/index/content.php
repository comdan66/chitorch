    ...
    <section class="grid col-three-quarters mq2-col-full">
      ...
      <article id="navplace">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="12%" bgcolor="#F7F7F7"><input type="checkbox" name="checkbox11" id="checkbox11"></td>
          ...
          <tr>
            ...
            <td>2014-06-06</td>
            <td class="textleft">Classics</td>
            <td class="textleft">BY11031</td>
            <td><a href="products_edit.html">修改</a></td>
          ...
          <tr>
            ...
            <td>2014-06-02</td>
            <td class="textleft">Stainless Steel &amp; Acetate</td>
            <td class="textleft">BY11031</td>
            <td><a href="products_edit.html">修改</a></td>
            <td><span class="added">上架</span></td>
            </tr>
          ...
          <tr>
            ...
            <td>2014-05-23</td>
            <td class="textleft">Optical frames</td>
            <td class="textleft">BY11030</td>
            <td><a href="products_edit.html">修改</a></td>
            <td>下架</td>
            </tr>
