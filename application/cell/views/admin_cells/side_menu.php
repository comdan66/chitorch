...
<!--
        ...
        <li class="item2"><a href="#"><span>產品管理</span></a>
          <ul>
        ...
        <li class="item3"><a href="#"><span>媒體露出管理</span></a>
          <ul>
            <li class="subitem1"><a href="<?php echo base_url (array ('admin', 'pres', 'pre_tags'));?>">新增媒體分類</a></li>
            <li class="subitem2"><a href="<?php echo base_url (array ('admin', 'pres'));?>">媒體露出列表</a></li>
            <li class="subitem3"><a href="<?php echo base_url (array ('admin', 'pres', 'create'));?>">新增媒體露出</a></li>
          </ul>
        </li>

        <li class="item4"><a href="#"><span>最新消息管理</span></a>
          <ul>
